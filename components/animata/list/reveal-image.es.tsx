...
function RevealImageListItem({ text, images }: ShowImageListItemProps) {
  ...
  return (
    <div className="group relative h-fit w-full overflow-visible py-8">
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-4xl font-black text-foreground transition-all duration-500 group-hover:opacity-40 text-center">
        {text}
      </h1>
